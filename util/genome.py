...
def get_feature_hit_set(mut_range, feat_df, feat_range_col, object_hit_col):
    feat_df_copy = feat_df.copy()
    feat_df_copy["mutation hit"] = feat_df_copy[feat_range_col].apply(is_overlap, args=(mut_range, ))
    hit_df = feat_df_copy[feat_df_copy["mutation hit"]]
